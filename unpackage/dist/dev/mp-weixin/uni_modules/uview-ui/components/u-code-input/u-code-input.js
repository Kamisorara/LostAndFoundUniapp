...
/* harmony import */ var _u_code_input_vue_vue_type_template_id_145d93e9_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./u-code-input.vue?vue&type=template&id=145d93e9&scoped=true& */ 443);
/* harmony import */ var _u_code_input_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./u-code-input.vue?vue&type=script&lang=js& */ 445);
...
/* harmony import */ var _u_code_input_vue_vue_type_style_index_0_id_145d93e9_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./u-code-input.vue?vue&type=style&index=0&id=145d93e9&lang=scss&scoped=true& */ 448);
    ...
    itemStyle: function itemStyle() {var _this = this;return function (index) {var addUnit = uni.$u.addUnit;var style = { width: addUnit(_this.size), height: addUnit(_this.size) }; // 盒子模式下，需要额外进行处理
        if (_this.mode === 'box') {// 设置盒子的边框，如果是细边框，则设置为0.5px宽度
          ...
          if (uni.$u.getPx(_this.space) === 0) {// 给第一和最后一个盒子设置圆角
            ...
            if (index !== _this.codeLength.length - 1) {style.borderRight = 'none';}}}if (index !== _this.codeLength.length - 1) {// 设置验证码字符之间的距离，通过margin-right设置，最后一个字符，无需右边框
