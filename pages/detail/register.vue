		...
		<view class="register-form" style="margin-top: 100rpx;">
			<u--form labelPosition="left" :model="model1" :rules="rules" ref="registerForm">
				...
				<u-form-item prop="userInfo.email" borderBottom ref="email">
					...
					<u--input v-model="model1.userInfo.email" border="none" placeholder="请输入邮箱"></u--input>
				</u-form-item>
				<u-form-item prop="userInfo.password1" borderBottom ref="password1">
					...
					<u--input v-model="model1.userInfo.password1" border="none" placeholder="请输入密码"></u--input>
				</u-form-item>
				<u-form-item prop="userInfo.password2" borderBottom ref="password2">
					...
					<u--input v-model="model1.userInfo.password2" border="none" placeholder="请输入的密码一致"></u--input>
				</u-form-item>
				<u-form-item prop="userInfo.code" borderBottom ref="code">
					...
					<u-code-input v-model="model1.userInfo.code" :space="0" mode="line"></u-code-input>
					<view class="wrap">
			...
			rules: {
				...
				'userInfo.password2': {
					...
					asyncValidator: (rule, value, callback) => {
						...
						if (this.model1.userInfo.password1 != this.model1.userInfo.password2) {
