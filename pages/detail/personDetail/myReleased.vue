<template>
	<view class="myReleased">
		<view class="title" style="font-size: 60rpx;font-weight: 600;margin: 50rpx;"><text>发布</text></view>
...
export default {
	...
	onReachBottom() {
		...
		setTimeout(() => {
			this.getHelpedNoticeLists(this.userInfo.id, this.pageNum, this.pageSize);
		}, 500);
	},
	onReady() {
